  ...
  constructor(props) {
    ...
    this.state = {
      ...
      searchParameters: [
        ...
        {
          spotifyName: '_acousticness',
          displayName: 'Acousticness',
          description: 'Coffee shop vibes or a raging concert?',
          min: 0,
          max: 100,
        },
        {
          spotifyName: '_tempo',
          displayName: 'Tempo',
          description: 'Still your heart or get the adrenaline pumping?',
          min: 0,
          max: 220,
        },
        {
          spotifyName: '_valence',
          displayName: 'Valence',
          description: 'Down in the dumps or feeling euphoric?',
          min: 0,
          max: 100,
        },
        {
          spotifyName: '_popularity',
          displayName: 'Popularity',
          description: 'Explore new artists or in with the radio tunes?',
          min: 0,
          max: 100,
        },
        {
          spotifyName: '_duration_ms',
          displayName: 'Duration',
          description: 'Just a quickie or a marathon?',
          min: 0,
          max: 15,
        },
      ],
  ...
  render() {
    ...
    for (let i = 0; i < this.state.searchParameters.length; i += 1) {
      sliders.push(
        <Filters
          key={'slider' + i}
          id={i}
          parameterObj={this.state.searchParameters[i]}
    ...
    return (
      <Fragment>
        ...
        <div className='searchParams'>{sliders}</div>
        <button
          className='theSpoogle'
          onClick={() => {
